...
@ActiveProfiles(profiles = {"postgres-manual"})
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@AutoConfigureWebTestClient
class PostgresManualPaginationIT {

  @Autowired private WebTestClient webClient;
  @Autowired private CustomerRepositoryPort customerRepository;

  @BeforeEach
  void cleanup() {
    customerRepository.deleteByName("test name");
  }
